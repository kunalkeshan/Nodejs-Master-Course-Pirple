      ...
      if (!err && userData) {
        ...
        if (hashedPassword == userData.hashedPassword) {
          ...
          _data.create('tokens', tokenId, tokenObject, function (err) {
            ...
            _performance.measure('Token data creating', 'creating data for token', 'beginning storing token');
        ...
        _data.read('users', userPhone, function (err, userData) {
          if (!err && userData) {
            ...
            if (userChecks.length < config.maxChecks) {
              ...
              // Verify that the url given has dns entries and can resolve
              ...
              dns.resolve(hostName, function (err, records) {
                if (!err && records) {
                  ...
                  callback(400, { 'Error': "Given hostname did not resolve with any dns records." })
                }
              })
